...
class BitBoxBaseConnect extends Component<Props, State> {
    ...
    public render(
        ...
        let bases = Object.entries(detectedBases);
        bases.push(['name', 'blah']);
        return (
                                        ...
                                        <div className="box">
                                            {
                                                bitboxBaseIDs.length ?  bitboxBaseIDs.map(baseID => (
                                                    ...
                                                    <p className="m-none text-center">{t('bitboxBase.detectedBasesEmpty')}</p>
                                                )
                                            }
                                        </div>
                                    </div>
                                        ...
                                        <div className="box">
                                            {
                                                bases.length ? bases.map(base => (
                                                    ...
                                                    <p className="m-none text-center">
